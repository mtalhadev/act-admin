<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ScheduleTypesEdit.aspx.cs" Inherits="ScheduleTypesEdit" Title="ScheduleTypes Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Schedule Types - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="ScheduleTypeId" runat="server" DataSourceID="ScheduleTypesDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ScheduleTypesFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:ScheduleTypesDataSource ID="ScheduleTypesDataSource" runat="server"
			SelectMethod="GetByScheduleTypeId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="ScheduleTypeId" QueryStringField="ScheduleTypeId" Type="String" />
		...
		<data:ScheduleDataSource ID="ScheduleDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ScheduleFilter  Column="ScheduleTypeId" QueryStringField="ScheduleTypeId" /> 
					</Filters>
				</data:SqlParameter>
