<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ScheduleTransportationTypesEdit.aspx.cs" Inherits="ScheduleTransportationTypesEdit" Title="ScheduleTransportationTypes Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Schedule Transportation Types - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="TransportationTypeId" runat="server" DataSourceID="ScheduleTransportationTypesDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ScheduleTransportationTypesFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>ScheduleTransportationTypes not found!</b>
			</EmptyDataTemplate>
		...
		<data:ScheduleTransportationTypesDataSource ID="ScheduleTransportationTypesDataSource" runat="server"
			SelectMethod="GetByTransportationTypeId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="TransportationTypeId" QueryStringField="TransportationTypeId" Type="String" />
		...
		<data:ScheduleDataSource ID="ScheduleDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ScheduleFilter  Column="TransportationTypeId" QueryStringField="TransportationTypeId" /> 
					</Filters>
				</data:SqlParameter>
