<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ScheduleUsersEdit.aspx.cs" Inherits="ScheduleUsersEdit" Title="ScheduleUsers Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Schedule Users - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="ScheduleUserId" runat="server" DataSourceID="ScheduleUsersDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ScheduleUsersFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:ScheduleUsersDataSource ID="ScheduleUsersDataSource" runat="server"
			SelectMethod="GetByScheduleUserId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="ScheduleUserId" QueryStringField="ScheduleUserId" Type="String" />
		...
		<data:ScheduleChangeUsersDataSource ID="ScheduleChangeUsersDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ScheduleChangeUsersFilter  Column="ScheduleUserId" QueryStringField="ScheduleUserId" /> 
					</Filters>
				</data:SqlParameter>
